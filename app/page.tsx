      ...
      <header className="relative z-10 px-4 py-6 sm:px-6 lg:px-8">
        <nav className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center space-x-3">
            ...
            />
            <span className="text-white font-bold text-xl">JSExec</span>
          </div>
          <div className="hidden md:flex items-center space-x-8">
            <a href="#features" className="text-gray-300 hover:text-white transition-colors">Features</a>
            <a href="#tech" className="text-gray-300 hover:text-white transition-colors">Technology</a>
            <a href="https://github.com/FranciscoJBrito/JSExec" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-300 hover:text-white transition-colors">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl">
              ...
              <div className="bg-blue-900/20 border border-blue-700/50 rounded-xl p-6 text-center hover:border-blue-500/70 transition-all duration-300 hover:bg-blue-900/30">
                ...
                <div className="space-y-3">
                  <a 
                    href="https://github.com/FranciscoJBrito/JSExec/releases/download/v1.0.0/JSExec-darwin-arm64-1.0.0.zip" 
                    target="_blank" 
                  ...
                  <a 
                    href="https://github.com/FranciscoJBrito/JSExec/releases/download/v1.0.0/JSExec-1.0.0-x64.dmg" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="block bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg text-sm transition-all duration-200 font-medium shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
              ...
              <div className="bg-blue-900/20 border border-blue-700/50 rounded-xl p-6 text-center hover:border-blue-500/70 transition-all duration-300 hover:bg-blue-900/30">
                ...
                <a 
                  href="https://github.com/FranciscoJBrito/JSExec/releases/download/v1.0.0/JSExec-Setup-1.0.0.exe" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg text-sm transition-all duration-200 font-medium shadow-lg hover:shadow-xl transform hover:scale-105"
                >
              ...
              <div className="bg-blue-900/20 border border-blue-700/50 rounded-xl p-6 text-center hover:border-blue-500/70 transition-all duration-300 hover:bg-blue-900/30">
                ...
                <div className="space-y-3">
                  <a 
                    href="https://github.com/FranciscoJBrito/JSExec/releases/download/v1.0.0/jsexec_1.0.0_amd64.deb" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="block bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg text-sm transition-all duration-200 font-medium shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
                  ...
                  <a 
                    href="https://github.com/FranciscoJBrito/JSExec/releases/download/v1.0.0/jsexec-1.0.0.x86_64.rpm" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="block bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg text-sm transition-all duration-200 font-medium shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <a 
                href="https://github.com/FranciscoJBrito/JSExec" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://github.com/FranciscoJBrito/JSExec/releases/tag/v1.0.0" 
                target="_blank" 
                rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/FranciscoJBrito/JSExec" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="https://github.com/FranciscoJBrito/JSExec/releases" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Download</a></li>
                <li><a href="https://github.com/FranciscoJBrito/JSExec/blob/main/README.md" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Documentation</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="https://github.com/FranciscoJBrito/JSExec" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">GitHub</a></li>
                <li><a href="https://github.com/FranciscoJBrito/JSExec/issues" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Issues</a></li>
                <li><a href="https://github.com/FranciscoJBrito/JSExec/discussions" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Discussions</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 JSExec. Made with ❤️ by <a href="https://github.com/FranciscoJBrito" target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300 transition-colors">Francisco Brito</a>
            </p>
          </div>
        </div>
      </footer>
